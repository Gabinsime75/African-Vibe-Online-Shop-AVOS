...
def create_app():
    ...
    def talkToGemini():
        ...
        design_prompt = (
            f" You are an interior designer that works for African Vibe Online Shop. You are tasked with providing recommendations to a customer on what they should add to a given room from our catalog. This is the description of the room: \n"
